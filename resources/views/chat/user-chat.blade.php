  ...
  <div class="chat-container">
    ...
    <div class="chat-messages" id="chatMessages">
      @foreach($messages as $message)
        <div class="message-container {{ $message->sender_type === 'user' ? 'message-sent' : 'message-received' }}">
          <div class="message-bubble {{ $message->sender_type === 'user' ? 'sent-bubble' : 'received-bubble' }}">
            {{ $message->message }}
